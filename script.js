 ...
 * No LocalStorage. Direct connection to Firebase Realtime Database.
 */
...
class Backend {
    ...
    async login(memberId, mobile) {
        ...
        if (memberId === '100' && mobile === '01700000000') {
            return { memberId: '100', name: 'Admin User', role: 'Admin', mobile: '01700000000' };
        }
...
function renderLogin() {
    ...
    <div class="card" style="max-width: 400px; margin: 40px auto; border-top: 5px solid var(--primary);">
        ...
        <div style="margin-top: 25px; padding-top: 20px; border-top: 1px solid #eee; font-size: 0.8rem; color: #888;" class="text-center">
            ...
            <p>Note: Add members via Admin panel first.</p>
        </div>
    </div>`;
}
    ...
    modal.innerHTML = `
        <div class="receipt-card" id="receipt-content">
            <div class="receipt-header">
                <div class="logo" style="justify-content: center; color: white; margin-bottom: 5px;">
                    <i class="fa-solid fa-building-user"></i> Taqwa Property BD
                </div>
                <h3 style="border:none; margin:0; padding:0; font-size: 1.2rem; color:white;">Payment Receipt</h3>
                <p style="font-size: 0.75rem; color: rgba(255,255,255,0.8); text-transform: uppercase; letter-spacing: 1px;">Official Record</p>
            </div>
